...
def get_data(dataset='mnist', noise_ratio=0, data_ratio=100, random_shuffle=False):
    ...
    if dataset == 'mnist' or dataset == 'fashion_mnist':
        if dataset == 'mnist':
            ...
            X_train = idx2numpy.convert_from_file("/le_0_in_%d/train-images-idx3-ubyte" % 40)
            X_test = idx2numpy.convert_from_file("/le_0_in_%d/t10k-images-idx3-ubyte" % 40)
            y_train = idx2numpy.convert_from_file("/le_0_in_%d/train-labels-idx1-ubyte" % 40)
            y_test = idx2numpy.convert_from_file("/le_0_in_%d/t10k-labels-idx1-ubyte" % 40)
