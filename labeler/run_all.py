...
def saveToFile(labeler, ks, label_error, image_noise, epochs, count, accuracy):
    with open("intermediate_results.txt", "a") as result_file:
        result_file.write("\n")
        result_file.write(
            "Index: " + str(count) + ", labeler: " + str(labeler) + ", ks: " + str(ks) + ", label_error: " + str(
            ...
            for e in experiments:
                if count > -1:
                    ...
                    command = 'python3 main.py -s mnist -a ' + str(alpha) + ' -b ' + str(beta) + ' -t ' + str(
                        ...
                        label_error) + ' -in ' + str(image_noise) + ' -la ' + str(i)
                    ...
                    # if r == repetition - 1:
                    saveToFile(i, j, label_error, image_noise, epochs, count, accuracy)
                count = count + 1
    print("Done!")
